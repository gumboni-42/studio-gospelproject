        ...
        S.list()
          ...
          .items([
            ...
            S.listItem()
              ...
              .child(
                S.document()
                  .schemaType('gospelvereinPage')
                  .documentId('gospelvereinPage')
              ),
            ...
            S.listItem()
              ...
              .id('zusammenklangPage')
              .icon(DocumentIcon)
              .child(
                S.document()
                  .schemaType('zusammenklangPage')
                  .documentId('zusammenklangPage')
              ),
